...
class conductanceTest(unittest.TestCase):
    ...
    def test_bullk_conduct(self):
        ...
        for count, system in enumerate(['7tu9', '7tvi', '8fe1']):
            ...
            self.assertAlmostEqual(hole1/pS, hole1_vec[count], places=6 )
            self.assertAlmostEqual(pf1/pS, pf1_vec[count], places=6 )
    ...
    def test_no_bulk_conduct(self):
        ...
        for count, system in enumerate( ['7tu9', '7tvi', '8fe1']):
            ...
            self.assertAlmostEqual(hole_c/pS, hole_vec[count], places=6 )
            self.assertAlmostEqual(pf1_c/pS, pf_vec[count], places=6 )
