...
In the accompanying `publication <https://doi.org/10.1016/j.bpj.2024.07.010>`_ , we explore the influence of pore shape on conductance and permeation.
If you use PoreAnalyser, please cite `Seiferth and Biggin, 2024 <https://doi.org/10.1016/j.bpj.2024.07.010>`_ .
